...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_TAB, KC_Z, KC_X, KC_C, KC_V, KC_B, MEH(KC_LEFT),                        MEH(KC_RGHT), KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, LALT(KC_TAB),
                CW_TOGG, KC_LALT, MO(3), LGUI_T(KC_SPC),                           LT(2, KC_BSPC), TG(1), KC_RALT, KC_DEL
    ),

    [1] = LAYOUT(
        XXXX, XXXX, XXXX, XXXX, XXXX, XXXX,                                                     XXXX, XXXX, XXXX, XXXX, XXXX, XXXX,
        XXXX, XXXX, XXXX, KC_DEL, XXXX, XXXX,                                                   LCTL(KC_Z), LCTL(KC_Z), TG(1), XXXX, LCTL(KC_P), XXXX,
        XXXX, XXXX, KC_HOME, LCTL(KC_LEFT), LCTL(KC_RGHT), KC_END,                              KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, XXXX, ____,
