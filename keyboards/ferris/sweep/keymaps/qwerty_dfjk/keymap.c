...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT(
        //  \        @      #        $         %                                              *        =       +        -        /
          KC_BSLS, KC_AT, KC_HASH, KC_DLR, KC_PERC,                                         KC_ASTR, KC_EQL, KC_PLUS, KC_MINS, KC_SLSH,
        //  <      >      (        )        '                                                 "        {        }        [        ]
          KC_LT, KC_GT, KC_LPRN, KC_RPRN, KC_QUOT,                                          KC_DQUO, KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC,
        //  :        _        |        &        ^                                             !        ?        ,        .       ;
          KC_COLN, KC_UNDS, KC_PIPE, KC_AMPR, KC_CIRC,                                      KC_EXLM, KC_QUES, KC_COMM, KC_DOT, KC_SCLN,
        //                               `                                                                  ~
                                       KC_GRV, KC_TAB,                                      LALT(KC_TAB), KC_TILD
    ),
